    ...
    <div class="content-wrapper">
        {!! Form::open(['route' => 'access.login', 'class' => 'login-form']) !!}
            ...
            <div class="form-group">
                ...
                {!! Form::text('username', old('username', app()->environment('demo') ? 'botble' : null), ['autofocus' => true, 'class' => 'form-control form-control-solid placeholder-no-fix', 'placeholder' => trans('core/acl::auth.login.username')]) !!}
            </div>
