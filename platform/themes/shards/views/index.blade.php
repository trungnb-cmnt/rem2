<?php 
    $featureCategories = get_featured_catalog_categories(10);
...
<section>
    ...
    <div id="banner" class="carousel slide" data-ride="carousel">
        <ol class="carousel-indicators">
            ...
            <li data-target="#banner" data-slide-to="<?php echo $key ?>" class="<?php if ($key == 0) echo 'active'; ?>">
            </li>
            @endforeach
        </ol>
                ...
                <div class="row">
                    <div class="col-12 d-flex flex-column align-items-center">
                        ...
                        <p class="text-center">Các sản phẩm của chúng tôi đều ược nhập khẩu chính hãng, có giấy chứng
                            nhận hợp quy của cơ quan chức năng. Sử dụng rèm cửa Minh Phương mang tới cho bạn một không
                            gian thật sự thoải mái và sang
                        ...
                        <div class="row list-product">
                            <div class="col-12 pb-4">
                                <div class="title-cate">
                                    <a href="{{ url($featureCategories->slug) }}"><span
                                            class="bg-category">{{ $featureCategories->name }} <span
                                                class="fa fa-forward"></span></span></a>
                                </div>
                            </div>
                            ...
                            <div class="col-6 col-md-3">
                                <div class="image medium-image">
                                    <a href="{{ url($product->slug) }}">
                                        <img src="{{ !empty($product->image) ? get_object_image($product->image,'medium') : '' }}"
                                            alt="{{ $product->name }}" />
                                    </a>
                                </div>
                ...
                <div class="col-md-4 pb-4">
                    <div class="why-choose-item p-4 d-flex justify-content-between">
                        ...
                        <div class="pl-3">
                            ...
                            Tuy có giá thành tương đối thấp so với sàn gỗ khác, nhưng các sản phẩm rèm cửa Minh Phương
                            vẫn đảm bảo chất lượng ưu việt cho người sử dung.
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 pb-4">
                    <div class="why-choose-item p-4 d-flex justify-content-between">
                        ...
                        <div class="pl-3">
                            ...
                            Rèm cửa Minh Phương không chỉ có tính đa dạng về mẫu mã mà còn có tính thẩm mỹ cao nên dễ
                            dàng được khách hàng ưu chuộng.
                        </div>
                    </div>
                </div>
                <div class="col-md-4 pb-4">
                ...
                <div class="col-md-4 pb-4">
                    <div class="why-choose-item p-4 d-flex justify-content-between">
                        ...
                        <div class="pl-3">
                            ...
                            Rèm cửa Minh Phương được chế tạo từ những nguyên liệu không gây ảnh hưởng đến tài nguyên và
                            môi trường.
                        </div>
                    </div>
                </div>
                <div class="col-md-4 pb-4">
                    <div class="why-choose-item p-4 d-flex justify-content-between">
                        ...
                        <div class="pl-3">
                            ...
                            Các dòng sản phẩm Rèm cửa Minh Phương đa dạng về mẫu mã, chủng loại, phù hợp với nhiều đối
