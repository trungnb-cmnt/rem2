                                ...
                                <article class="post post__inside post__inside--feature">
                                    ...
                                    <header class="post__header">
                                        ...
                                        <div class="post__meta"><span class="post-category"><i class="ion-cube"></i>
                                            ...
                                            <span class="created_at"><i class="ion-clock"></i><a href="#">{{ date_from_database($feature_item->publish_date, 'M d Y') }}</a></span>
                                                ...
                                                <article class="post post__vertical post__vertical--single">
                                                    ...
                                                    <div class="post__content-wrap">
                                                        <header class="post__header">
                                                            ...
                                                            <div class="post__meta"><span class="created__month">{{ date_from_database($post->publish_date, 'M') }}</span><span class="created__date">{{ date_from_database($post->publish_date, 'd') }}</span><span class="created__year">{{ date_from_database($post->publish_date, 'Y') }}</span></div>
                                                        </header>
                                                ...
                                                @else
                                                    <article class="post post__horizontal post__horizontal--single mb-20 clearfix">
                                                        ...
                                                        <div class="post__content-wrap">
                                                            <header class="post__header">
                                                                <h3 class="post__title"><a href="{{ route('public.single', $post->slug) }}">{{ $post->name }}</a></h3>
                                                                <div class="post__meta"><span class="post__created-at"><a href="#">{{ date_from_database($post->publish_date, 'M d, Y') }}</a></span></div>
                                                            </header>
                                                        </div>
                                                    </article>
                                                @endif
