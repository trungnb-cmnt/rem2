            ...
            switch ($slug->reference) {
                case POST_MODULE_SCREEN_NAME:
                    ...
                    if (!empty($post)) {
                        ...
                        Theme::breadcrumb()->add($post->name, route('public.single', $slug->key));

                        // LdJson
                        SeoHelper::setBreadCrumbs(Theme::breadcrumb()->getCrumbs());
                        SeoHelper::setpost($post);
                ...
                case CATEGORY_MODULE_SCREEN_NAME:
                    ...
                    if (!empty($category)) {
                        ...
                        $posts = $this->app->make(PostInterface::class)->getByCategory($allRelatedCategoryIds, 6);
