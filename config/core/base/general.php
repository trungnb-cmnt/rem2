...
return [
    ...
    'default-theme'             => env('DEFAULT_THEME', 'black'),
    'base_name'                 => env('APP_NAME', 'Botble Technologies'),
    'logo'                      => '/core/images/white_logo.png',
    'favicon'                   => '/core/images/black_logo.png',
    'editor'                    => [
        'ckeditor' => [
            'js' => [
    ...
    'send_mail_using_job_queue' => env('SEND_MAIL_USING_JOB_QUEUE', true),
    'locale'                    => env('APP_LOCALE', config('app.locale', 'en')),
];