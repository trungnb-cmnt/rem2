                            ...
                            <article class="post post__horizontal mb-40 clearfix">
                                ...
                                <div class="post__content-wrap">
                                    <header class="post__header">
                                        ...
                                        <div class="post__meta"><span class="post__created-at"><i class="ion-clock"></i><a href="#">{{ date_from_database($post->publish_date, 'M d, Y') }}</a></span>
                                            ...
                                            @endif
                                            <span class="post-category"><i class="ion-cube"></i><a href="{{ route('public.single', $category->slug) }}">{{ $category->name }}</a></span></div>
                                    </header>
